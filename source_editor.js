tinyMCEPopup.requireLangPack("advanced");
...
function resizeInputs() {
	...
	if (el) {
		//alert(vp.w + "w y h" + vp.h);		
		el.style.width = (vp.w - 4);  //'97%';		
		el.style.height = (vp.h - 70); //'86%';
		
		//el.style.width = (vp.w - 20) + 'px';		
		//el.style.height = (vp.h - 70) + 'px';
		//alert(el.style.width + "w y h" + el.style.height);		
	}
}
