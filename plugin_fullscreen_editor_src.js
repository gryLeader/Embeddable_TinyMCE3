		...
		init : function(ed, url) {
			...
			ed.addCommand('mceFullScreen', function() {
				...
				if (ed.getParam('fullscreen_new_window')) {
					...
					win = DOM.win.open(url + "/plugin_fullscreen.htm", "mceFullScreenPopup", "fullscreen=yes,menubar=no,toolbar=no,scrollbars=no,resizable=yes,left=0,top=0,width=" + screen.availWidth + ",height=" + screen.availHeight);
					try {
